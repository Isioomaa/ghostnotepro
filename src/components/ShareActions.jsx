...
const ShareActions = ({ sessionId, textToShare, analysisResult, isPro, onPaywallTrigger, onShowToast, url = "https://ghostnotepro.com" }) => {
    ...
    const handlePublish = async () => {
        ...
        try {
            ...
            if (onShowToast) {
                onShowToast("Public article link copied!");
            }
        } catch (err) {
            console.error("Publish failed", err);
            if (onShowToast) {
                onShowToast("Failed to publish. Try again.");
            }
        } finally {
    ...
    // (Actually I'll just rewrite the return to keep it clean)
    return (
